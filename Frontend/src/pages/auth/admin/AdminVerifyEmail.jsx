...
const TRUST_POINTS = ['Secure admin verification', 'OTP resend support', 'Dashboard unlock'];

const VERIFY_BENEFITS = [
  {
    title: 'Secure admin onboarding',
    description: 'Confirm your email before accessing the admin portal.',
  },
  {
    title: 'Fast recovery',
    description: 'Resend a fresh code if the first one arrives late.',
  },
  {
    title: 'Confident access',
    description: 'Unlock the dashboard only after successful verification.',
  },
];
          ...
          <aside className="relative hidden flex-col justify-between overflow-hidden bg-linear-to-br from-slate-900 via-slate-800 to-cyan-900 p-12 text-white lg:flex">
            ...
            <div className="relative z-10">
              <div className="mb-10 flex items-center gap-3" data-aos="fade-down">
                ...
                <div>
                  ...
                  <h2 className="text-2xl font-semibold">Admin Verification</h2>
                </div>
              </div>
              ...
              <div data-aos="fade-up" data-aos-delay="100">
                ...
                <h3 className="max-w-xl text-5xl font-semibold leading-tight">
                  Verify your account before entering the admin dashboard.
                </h3>
                <p className="mt-6 max-w-lg text-lg leading-8 text-cyan-50/90">
                  Enter the 6-digit code sent to your email to activate secure admin access.
                </p>
              </div>

              <div className="mt-10 space-y-5" data-aos="fade-up" data-aos-delay="180">
                {VERIFY_BENEFITS.map((item) => (
            ...
            <div className="relative z-10 grid grid-cols-3 gap-4 border-t border-white/10 pt-8" data-aos="fade-up" data-aos-delay="260">
              <div>
                ...
                <p className="mt-1 text-sm text-cyan-50/80">Secure code</p>
              </div>
              <div>
                <div className="text-3xl font-semibold">60s</div>
                <p className="mt-1 text-sm text-cyan-50/80">Resend timer</p>
              </div>
              <div>
                <div className="text-3xl font-semibold">Admin</div>
                <p className="mt-1 text-sm text-cyan-50/80">Portal access</p>
              </div>
            </div>
          </aside>
          ...
          <section className="relative bg-white px-6 py-10 sm:px-10 lg:px-12 lg:py-12">
            ...
            <div className="relative z-10 mx-auto max-w-xl" data-aos="fade-up">
              <div className="mb-8 flex items-center justify-between">
                <div>
                  <p className="text-xs font-semibold uppercase tracking-[0.35em] text-emerald-600">Admin verify</p>
              ...
              <div className="mb-6 rounded-2xl border border-slate-200 bg-slate-50/80 p-4 shadow-sm">
                {email ? (
                  ...
                  <>
                    <label className="mb-2 block text-sm font-semibold text-slate-900">Enter email address</label>
                    <input
                      type="email"
                      value={email}
              ...
              <div className="mt-6 rounded-2xl border border-slate-200 bg-slate-50/80 p-5 shadow-sm">
                <div className="flex items-center justify-between gap-4">
                  <div>
                    ...
                    <p className="mt-1 text-sm text-slate-600">Send another OTP if the email is delayed.</p>
                  </div>
                  <button
